...
test("healthz shape and no-store", async (t) => {
  ...
  assert.deepEqual(r.json, { ok: true, name: "sotto", version: "0.4.2", pid: process.pid, port: h.port, data_dir: h.dataDir, plugin_root: h.pluginRoot, state: "off", api_key: true });
});
