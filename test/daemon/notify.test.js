...
test("parseTaskNotifications: the real CLI 2.1.281 payload", () => {
  ...
  assert.deepEqual(parseTaskNotifications(prompt), [{ taskId: "ac0dd5dd9b41ce48c", toolUseId: "toolu_01555gFs6PBBXB1i4q2XkQNh", status: "completed", summary: 'Agent "count files" finished' }]);
