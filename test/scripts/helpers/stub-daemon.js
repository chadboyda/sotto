...
const server = createServer((req, res) => {
  ...
  req.on("end", () => {
    ...
    if (req.method === "GET" && url.pathname === "/healthz") {
      ...
      res.end(JSON.stringify({ ok: true, name: "sotto", version: "0.3.4", pid: process.pid, port, data_dir: dataDir, plugin_root: pluginRoot, state: "off", api_key: !!userConfigKey || existsSync(join(dataDir, "stub-has-key")) }));
      return;
    }
