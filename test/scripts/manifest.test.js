...
describe("manifests", () => {
  test("plugin.json: name, schema, userConfig defaults", () => {
    ...
    assert.deepEqual(m.userConfig.echo_guard.options, ["auto", "on", "off"]);
  ...
  test("SKILL.md frontmatter", () => {
    ...
    assert.match(s, /\nargument-hint: "\[on\|off\|status\|restart\|quiet\|milestones\|walkthrough\|voice \[name\]\|persona \[name\]\|app\|window \[auto\|app\|chrome\]\|cap \[off\|<minutes>\]\|key\]"\n/);
